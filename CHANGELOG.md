...
- Internal refactoring for improved maintainability (no behavior changes)
- Improved diff output using `similar` crate
...
[Unreleased]: https://github.com/psychollama/nufmt/compare/v0.9.0...HEAD
[0.9.0]: https://github.com/psychollama/nufmt/compare/v0.8.0...v0.9.0
[0.8.0]: https://github.com/psychollama/nufmt/compare/v0.7.0...v0.8.0
